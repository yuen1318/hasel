    ...
    <main>
        ...
        <form id="frm_update_account">
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card">
                        <input class="hide" type="text" name="id" value="<?php echo $_SESSION['admin_id'] ?>">
                        <div class="row">
                            <br>
                            <div class="col s12 m4 l4">
                                <label>First Name</label>
                                <input type="text" name="fn" value="<?php echo $_SESSION['admin_fn'] ?>">
                            </div>
                            <div class="col s12 m4 l4">
                                <label>Middle Name</label>
                                <input type="text" name="mn" value="<?php echo $_SESSION['admin_mn'] ?>">
                            </div>
                            <div class="col s12 m4 l4">
                                <label>Last Name</label>
                                <input type="text" name="ln" value="<?php echo $_SESSION['admin_ln'] ?>">
                            </div>
                        </div>
                        <!--row-->
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m4 l4">
                                ...
                                <select name="gender" class="browser-default">
                                    <option value="<?php echo $_SESSION['admin_gender'] ?>" selected>Default</option>
                            ...
                            <div class="col s12 m4 l4">
                                <label>Mobile</label>
                                <input type="number" name="mobile" value="<?php echo $_SESSION['admin_mobile'] ?>">
                            </div>
                            <div class="col s12 m4 l4">
                                <label>Email</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m12 l12">
                                <label>Address</label>
                                <input type="text" name="address" value="<?php echo $_SESSION['admin_address'] ?>">
                            </div>
                        </div>
                        <!--row-->
                        <br>
            ...
            <form id="frm_update_password">
                <div class="modal-content">
                    ...
                    <div class="row hide">
                        <div class="col s12 m12 l12">
                            <label>ID</label>
                            <input type="text" name="id" readonly value="<?php echo $_SESSION['admin_id'] ?>">
                        </div>
                    </div>
    ...
    $(function () {
        ...
        $('#btn_update_account').on('click', function () { //validate on btn click
            if ($("#frm_update_account").valid()) { //check if all field is valid
                update_account("../../model/tbl_admin/update/update_account.php","#frm_update_account");
            } else {
        ...
        $('#btn_update_password').on('click', function () { //validate on btn click
            if ($("#frm_update_password").valid()) { //check if all field is valid
                update_password("../../model/tbl_admin/update/update_password.php",
                    "#frm_update_password");
            } else {
                $('.val').addClass('animated bounceIn');
                $('.val').one(
